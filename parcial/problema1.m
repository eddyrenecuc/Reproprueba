...
while true
    ...
    switch opcion
        case 1
            ...
            insert_query = sprintf("INSERT INTO problema1 (identificacion, nombre, edad, genero, direccion) VALUES ('%s', '%s', %d, '%s', '%s');", identificacion, nombre, edad, genero, direccion);
        ...
        case 2
            ...
            select_query = sprintf("SELECT * FROM problema1 WHERE identificacion = '%s';", identificacion);
            ...
            if !isempty(result.data)
                ...
                update_query = sprintf("UPDATE problema1 SET nombre = '%s', edad = %d, genero = '%s', direccion = '%s' WHERE identificacion = '%s';", nombre, edad, genero, direccion, identificacion);
        ...
        case 3
            ...
            if !isempty(result.data)
                ...
                delete_query = sprintf("DELETE FROM problema1 WHERE identificacion = '%s';", identificacion);
        ...
        case 4
            ...
            select_all_query = "SELECT * FROM problema1;";
