    ...
    while true
        ...
        switch opcion
            case 1
                ...
                insert_query = sprintf("INSERT INTO problema9 (nombre, precio, cantidad) VALUES ('%s', %f, %d);", nombre, precio, cantidad);
            ...
            case 2
                ...
                update_query = sprintf("UPDATE problema9 SET cantidad = %d WHERE nombre = '%s';", nueva_cantidad, nombre_producto);
