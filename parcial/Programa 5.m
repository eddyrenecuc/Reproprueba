    ...
    while true
        ...
        switch opcion
            case 1
                ...
                insert_query = sprintf("INSERT INTO problema5 (fecha, producto, cantidad, ingresos) VALUES ('%s', '%s', %s, %d);", fecha, producto, cantidad, ingresos);
            ...
            case 2
                ...
                update_query = sprintf("UPDATE problema5 SET ingresos = %d;", ingresos);
            ...
            case 3
                ...
                delete_query = sprintf("DELETE FROM problema5 WHERE producto = '%s';", producto);
...
case 4
    fprintf('\nLista de ventas:\n');
    select_query = "SELECT * FROM problema5";
